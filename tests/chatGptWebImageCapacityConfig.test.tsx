...
`;
  ...
  test('uses backend-identical defaults and validation bounds', () => {
    ...
    Object.assign(values, {
      chatgptWebImageMaxInFlight: '0',
      chatgptWebImageAdmissionQueueSize: '513',
    ...
    expect(getVisualConfigValidationErrors(values)).toMatchObject({
      chatgptWebImageMaxInFlight: 'integer_range_1_512',
      chatgptWebImageAdmissionQueueSize: 'integer_range_0_512',
  ...
  test('renders the six controls behind one progressive disclosure', () => {
    render(
  ...
  test('indexes all six settings and defines labels in every locale', () => {

...
const extractSectionValue = (config: Config | null, section?: RawConfigSection) => {
  ...
  switch (section) {
    ...
    case 'routing/session-affinity-use-history':
      return config.routingSessionAffinityUseHistory;
    ...
    case 'routing/session-affinity-lcp':
      return config.routingSessionAffinityLCP;
    ...
    set((state) => {
      ...
      switch (section) {
        ...
        case 'routing/session-affinity':
          ...
          break;
        case 'routing/session-affinity-use-history':
          nextConfig.routingSessionAffinityUseHistory = value as Config['routingSessionAffinityUseHistory'];
          break;
        case 'routing/session-affinity-across-priorities':
        ...
        case 'routing/session-affinity-subagents':
          ...
          break;
        case 'routing/session-affinity-lcp':
          nextConfig.routingSessionAffinityLCP = value as Config['routingSessionAffinityLCP'];
          break;
        case 'routing/session-affinity-failover':

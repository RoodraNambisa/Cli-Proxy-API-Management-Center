...
import type { AuthFileItem, CodexRateLimitResetCredit, ResolvedTheme, ThemeColors } from '@/types';
...
export interface QuotaRenderHelpers {
  ...
  renderResetCreditAction?: (credit: CodexRateLimitResetCredit) => ReactNode;
}

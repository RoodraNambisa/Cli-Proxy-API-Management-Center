...
export const CONFIG_PAGE_DEFINITIONS: ConfigPageDefinition[] = [
  ...
  },
  {
    ...
    dirtyPrefixes: ['authDir', 'rmSecretKey', 'apiKeysText', 'apiKeyNames', 'authModelExclusions'],
  },
  {
    id: 'global-network',
    group: 'global',
...
export const CONFIG_SEARCH_DEFINITIONS: ConfigSearchDefinition[] = [
  ...
  },
  {
    ...
    yamlKeys: [
      ...
      'input-modalities', 'openai-compatibility[].models[].input-modalities',
    ...
    aliases: ['model display name', 'context window override', 'reasoning capabilities', 'thinking budget', 'zero_allowed', 'dynamic_allowed', '显示名称', '上下文容量', '推理能力', '推理预算', '顯示名稱', '推理預算', 'объём контекста', 'возможности рассуждения', 'reasoning history compatibility', '思考历史兼容', '思考歷史相容', 'совместимость истории рассуждений', 'input types', 'text only', '输入类型', '工具图片', '輸入類型', '工具圖片', 'типы ввода'],
  },
  {
  ...
  },
  {
    ...
    yamlKeys: [
      ...
      'chatgpt-web.sentinel.go-vm-compatibility',
      'chatgpt-web.sentinel.go-vm-compatibility.enabled',
      'chatgpt-web.sentinel.go-vm-compatibility.observer-state-auto-extend',
      'chatgpt-web.sentinel.go-vm-compatibility.writable-window-properties',
      'chatgpt-web.sentinel.go-vm-compatibility.environment-properties',
    ],
    aliases: ['sentinel sdk', 'solver pool', 'go vm', 'compatibility rules', '求解池', '兼容规则', '相容規則'],
  },
  {

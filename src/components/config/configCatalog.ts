...
export const CONFIG_SEARCH_DEFINITIONS: ConfigSearchDefinition[] = [
  ...
  },
  {
    ...
    yamlKeys: ['routing.strategy', 'routing.priority-overrides', 'routing.fill-first-range'],
  ...
  },
  {
    ...
    yamlKeys: ['routing.priority-overrides', 'max-retry-credentials', 'fill-first-per-auth-rpm'],
  },
  {
  ...
  },
  {
    ...
    yamlKeys: ['codex-identity-confuse', 'codex-fingerprint', 'force-http1', 'images-force-http1'],
  ...
  },
  {
    ...
    yamlKeys: ['codex-header-defaults', 'user-agent', 'beta-features', 'originator'],
  },
  {
